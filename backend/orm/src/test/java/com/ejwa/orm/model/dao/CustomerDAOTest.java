...
public class CustomerDAOTest {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class)
                .addClasses(CustomerDAO.class, Category.class, CustomerOrderClothingItemId.class, CustomerOrderClothingItem.class, ClothingItem.class, SizeQuantity.class, SizeQuantityId.class, Customer.class, CustomerOrder.class, Payment.class)
